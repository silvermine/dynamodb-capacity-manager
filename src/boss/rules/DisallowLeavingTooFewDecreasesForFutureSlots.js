...
module.exports = BaseRule.extend({
   ...
   apply: function(state) {
      var decreasesLeft = (MAX_DECREASES_PER_DAY - state.provisioning.NumberOfDecreasesToday),
          ...
          fullSlotsLeft = Math.floor(secondsToEndOfDay / (86400 / MAX_DECREASES_PER_DAY)); // 86,400 is seconds in a day
