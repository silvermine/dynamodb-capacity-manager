...
describe('DisallowTooSoonOrFrequent', function() {
   ...
   describe('apply', function() {
      ...
      it('disallows change when trending down and not enough time has elapsed since the last decrease', function() {
         ...
         runTest(50, '2016-08-18T20:09:59.999Z', 0, false);
      });
      ...
      it('allows change other times', function() {
         ...
         runTest(50, '2016-08-18T20:10:01.000Z', 0, undefined);
         runTest(50, '2016-08-18T20:10:01.000Z', 1, undefined);
         runTest(50, '2016-08-18T20:10:01.000Z', 2, undefined);
         runTest(50, '2016-08-18T20:10:01.000Z', 3, undefined);
      });
